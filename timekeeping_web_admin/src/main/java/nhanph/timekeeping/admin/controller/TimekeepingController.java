...
import nhanph.timekeeping.admin.constant.Constants;
...
public class TimekeepingController {
    ...
    @Autowired
    public TimekeepingController(CustomerGroupRepository customerGroupRepository, CustomerRepository customerRepository,
                                 TimeKeepingRepository timeKeepingRepository) {
        this.customerGroupRepository = customerGroupRepository;
        this.timeKeepingRepository = timeKeepingRepository;
        this.customerRepository = customerRepository;
        this.groups = customerGroupRepository.getGroupList();
    ...
    public void getPeopleListByPeopleId() {
        ...
        peopleList = customerRepository.searchPeopleList(peopleIdSearch, null, null);
